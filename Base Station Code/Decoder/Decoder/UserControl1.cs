...
namespace Decoder
{
    ...
    /// </summary>
    public class SpeedControl2 : System.Windows.Forms.UserControl
    {
        /// <summary>
        ...
        private void UserControl1_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            ...
            g.DrawString("COMPASS", f, Brushes.Green, -60, this.Height / -4);
            ...
            //int sp = 0;
            g.DrawString("N", f, Brushes.Blue, -13, 0);
            /*for(int x = 0; x<7;x++)
            {
            ...
            g.ResetTransform();
            g.TranslateTransform(90, (this.Height / 2) - 13);
            g.DrawString("E", f, Brushes.Blue, 0, 0);
            g.ResetTransform();
            g.TranslateTransform(this.Width - 105, (this.Height / 2) - 13);
            g.DrawString("W", f, Brushes.Blue, -13, 0);
            g.ResetTransform();
            ...
            Pen P = new Pen(Brushes.Black, 14);
